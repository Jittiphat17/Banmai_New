...
Public Class TestGetData
    ...
    Private Sub FetchIncomeDetails()
        Try
            ...
            Dim ind_date As DateTime = DateTimePicker1.Value

            ' แปลงวันที่ให้เป็นรูปแบบที่ MS Access เข้าใจ (MM/dd/yyyy)
            Dim ind_date_formatted As String = ind_date.ToString("dd/MM/yyyy")
            ...
            cmd.Parameters.AddWithValue("@ind_date", ind_date_formatted) ' ใช้วันที่ในรูปแบบ dd/MM/yyyy
            ...
            If reader.Read() Then
                ...
                TextBox4.Text = retrievedDate.ToShortDateString() ' แสดงวันที่ในรูปแบบที่เข้าใจง่าย
            Else
                MessageBox.Show("ไม่พบข้อมูลที่ตรงกับเงื่อนไข")
                TextBox3.Clear()
            End If
    ...
    Private Sub ContractConAmount()
        Try
            ...
            Dim con_date_formatted As String = con_date.ToString("dd/MM/yyyy")
    ...
    Private Sub GetDataPrincipal()
        Try
            ...
            Dim payment_date_formatted As String = payment_date.ToString("dd/MM/yyyy") ' ใช้รูปแบบ MM/dd/yyyy เพื่อให้สอดคล้องกับ MS Access
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            ...
            cmd1.Parameters.AddWithValue("@payment_Mprincipal", TextBox9.Text)
            cmd1.Parameters.AddWithValue("@con_id", TextBoxConId.Text)
            cmd1.Parameters.AddWithValue("@payment_date", DateTimePicker1.Value.ToString("dd/MM/yyyy"))
            ...
            cmd2.Parameters.AddWithValue("@payment_Principal", TextBox9.Text)
            cmd2.Parameters.AddWithValue("@con_id", TextBoxConId.Text)
            cmd2.Parameters.AddWithValue("@next_payment_date", nextMonthDate.ToString("dd/MM/yyyy"))
