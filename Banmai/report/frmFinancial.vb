    ...
    Private Sub LoadFinancialReport()
        ...
        Try
            ...
            With sb
                ...
                .Append(",(f.IncLoanAmt - f.ExdLoanAmt) as LoanAmt,(f.IncStmAmt - f.ExpStmAmt) as IncExpAmt ")
                ...
                .Append("from income_details ")
                .Append("where acc_id = @para_accid and ind_date between @para_dat1 and @para_dat2 ")
                .Append("and ind_accname in('ดอกเบี้ยเงินฝากธนาคาร','ค่าธรรมเนียมแรกเข้า','ค่าปรับ','ค่าเอกสาร','เงินบริจาค','ค่าธรรมเนียม','อื่น ๆ') ")
                .Append("group by acc_id ")
                ...
                .Append("from expense_details ")
                .Append("where acc_id = @para_accid and exd_date between @para_dat1 and @para_dat2 ")
                .Append("and exd_nameacc in('ค่าเช่าสำนักงาน','เงินสมทบ','เงินประกันความเสี่ยง','ค่าตอบแทน','ค่าจ้าง','ดอกเบี้ยสัจจะ','ดอกเบี้ยจ่าย','อื่นๆ') ")
                .Append("group by acc_id ")
